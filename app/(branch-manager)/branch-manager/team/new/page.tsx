...
export default function BranchManagerNewTeamMemberPage() {
  ...
  async function onSubmit(data: InviteTeamMemberInput) {
    ...
    try {
      ...
      router.push('/branch-manager/team')
    } finally {
      setIsPending(false)
    }
  }
            ...
            <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-4">
              ...
              {watchedEmail && (
                <div className="flex items-start gap-2 rounded-lg border border-blue-200 bg-blue-50 px-3 py-2.5 text-sm text-blue-700 dark:border-blue-800 dark:bg-blue-950 dark:text-blue-300">
                  ...
                  <span>
                    ...
                    <strong>{watchedEmail}</strong>. They will be prompted to change their password on first login.
                  </span>
                </div>
              )}
              ...
              <div className="flex gap-3 pt-2">
                ...
                <Button variant="outline" type="button" asChild>
                  <Link href="/branch-manager/team">Cancel</Link>
                </Button>
              </div>
            </form>
          </Form>
