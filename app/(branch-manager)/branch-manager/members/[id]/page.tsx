...
export default async function BranchManagerMemberDetailPage({ params }: PageProps) {
        ...
        action={
          <div className="flex items-center gap-2">
            ...
            <Button asChild variant="outline" size="sm">
              <Link href={`/branch-manager/members/${params.id}/edit`}>
